...
driver.implicitly_wait(5) #tell the driver to wait a second if it doesn't see the thing it's looking for (for javascript)
...
for region in regions:
    ...
    for centerPage in centerLinks:
        ...
        writer.writerow({'region': region, 'page-header': header, 'link': centerPage, 'address': address})
